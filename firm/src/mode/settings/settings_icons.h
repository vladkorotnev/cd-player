...
namespace {
    ...
    const uint8_t icn_server_data[] = {
        0xff, 0x5d, 0xff, 0x41, 0xff, 0x7f, 0xd7, 0x41, 0xab, 0x41, 0xd7, 0x7f, 0xab, 0x7f, 0xd7, 0x4f, 
        0xff, 0x4f, 0xff, 0x7f, 0xff, 0x7f, 0xff, 0x7f, 0xff, 0x7f, 0xff, 0x7f, 0x00, 0x00, 0x61, 0x86
    };
...
const EGImage icn_server = {
    .format = EG_FMT_HORIZONTAL,
    .size = {16, 16},
    .data = icn_server_data
};
